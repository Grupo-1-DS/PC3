...
def test_successful_saga(fresh_metrics):
...
def test_failed_sagas(fresh_metrics, fail_config, expected_step):
...
def test_metrics_tracking(fresh_metrics):
...
def test_full_metrics_report(fresh_metrics):
    print("\n" + "="*70)
